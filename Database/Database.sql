...
create table GiayKhaiSinh (
    ...
    SoGiayKhaiSinh NVARCHAR(20), -- Số giấy khai sinh là khóa chính
    HoVaTenCha NVARCHAR(255), -- Họ và tên cha
    HoVaTenMe NVARCHAR(255), -- Họ và tên mẹ
    HoVaTenCon NVARCHAR(255), -- Họ và tên người được sinh
    GioiTinhCon NVARCHAR(10), -- Giới tính của người được sinh (Nam hoặc Nữ)
    NgaySinhCon DATE, -- Ngày sinh của người được sinh
    DanTocCon NVARCHAR(255), -- Nơi sinh của người được sinh
    QuocTichCon NVARCHAR(50) -- Quốc tịch của người được sinh
);
GO

INSERT INTO GiayKhaiSinh (SoGiayKhaiSinh, HoVaTenCha, HoVaTenMe, HoVaTenCon, GioiTinhCon, NgaySinhCon, DanTocCon, QuocTichCon)
VALUES
('GKS001', 'Nguyễn Văn A', 'Trần Thị B', 'Nguyễn Thị C', 'Nam', '2000-01-15', 'Kinh', 'Việt Nam'),
('GKS002', 'Lê Văn D', 'Nguyễn Thị E', 'Lê Thị F', 'Nữ', '1998-05-20', 'Kinh', 'Việt Nam'),
('GKS003', 'Trần Văn G', 'Phạm Thị H', 'Trần Thị I', 'Nam', '2002-09-10', 'Kinh', 'Việt Nam');
GO
